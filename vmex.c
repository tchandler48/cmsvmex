...
void Print_pr()
{
 ...
 printf("Starting cell wk_row = %s x = %d\n",wk_row,x); 
 ...
 printf("Starting st_col = %d st_row = %d\n",st_col,st_row); 
 ...
 printf("Ending col end_col = %d end_row = %d\n",end_col, end_row); 

   fp = fopen("PRT", "w");
   fprintf(fp, "%s","This is a test\n");
   fprintf(fp, "%s","LINE TWO\n");
   fprintf(fp, "%s","LINE THREE\n");
